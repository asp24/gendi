...
func TestStandardCasterToInt64(t *testing.T) {
	...
	runCastTests(t, []castTest{
		...
		{"uint in range", uint(10), int64(10), ""},
		{"uint overflow", uint(math.MaxUint64), int64(0), "overflows"},
...
func TestStandardCasterToUint64(t *testing.T) {
	...
	runCastTests(t, []castTest{
		...
		{"int8 positive", int8(8), uint64(8), ""},
		{"int8 negative", int8(-8), uint64(0), "negative"},
		{"int16 positive", int16(16), uint64(16), ""},
		{"int16 negative", int16(-16), uint64(0), "negative"},
		{"int32 positive", int32(32), uint64(32), ""},
		{"int32 negative", int32(-32), uint64(0), "negative"},
		{"int64 positive", int64(64), uint64(64), ""},
		{"int64 negative", int64(-64), uint64(0), "negative"},
		...
		{"named input rejected", namedInt(1), uint64(0), "parameters.namedInt"},
...
func TestStandardCasterToFloat64(t *testing.T) {
	...
	runCastTests(t, []castTest{
		...
		{"plain int exact", int(1024), float64(1024), ""},
		{"plain int inexact", int(1<<53 + 1), float64(0), "not exactly representable"},
		{"uint inexact", uint(1<<53 + 1), float64(0), "not exactly representable"},
		{"int8", int8(-8), float64(-8), ""},
		{"int16", int16(-16), float64(-16), ""},
		{"int32", int32(-32), float64(-32), ""},
		{"uint small", uint(16), float64(16), ""},
		{"uint8", uint8(8), float64(8), ""},
		{"uint16", uint16(16), float64(16), ""},
		{"uint32", uint32(32), float64(32), ""},
		{"uint exact", uint64(16), float64(16), ""},
		{"uint64 inexact", uint64(1<<53 + 1), float64(0), "not exactly representable"},
		{"string", "1e3", 1000.0, ""},
		{"string invalid", "abc", float64(0), `cannot cast string "abc" to float64`},
...
func TestStandardCasterToString(t *testing.T) {
	...
	runCastTests(t, []castTest{
		...
		{"float64 NaN rejected", math.NaN(), "", "NaN and infinities"},
		{"float32", float32(2.5), "2.5", ""},
		{"float32 Inf rejected", float32(math.Inf(1)), "", "NaN and infinities"},
...
func TestStandardCasterToDuration(t *testing.T) {
	...
	runCastTests(t, []castTest{
		...
		{"float32 rejected", float32(1.5), time.Duration(0), "cannot cast"},
		...
		{"named input rejected", namedInt(1), time.Duration(0), "parameters.namedInt"},
